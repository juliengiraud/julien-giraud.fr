...
$lastupdate = "11/06/2020";

?>

<!DOCTYPE html>

<!-- Bienvenue dans le code de mon site. Ici tout est fait à la main, bonne lecture ! -->
                    ...
                    <ul class="navbar-items">
                        ...
                        <li class="navbar-item has-dropdown">
                            ...
                            <ul class="navbar-items">
                                ...
                                <li class="navbar-item navbar-divider">
                                    <a href="<?= $adresse ?>/formation-rubiks-cube" title="Consulter mon guide">Formation</a>
                                </li>
                                <li class="navbar-item">
