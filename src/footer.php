        <footer>
            <div class="footer-container">
                ...
                <div class="footer-logo">
                    ...
                    <a href="<?= $adresse ?>" title="Accueil portfolio">
                        <img src="<?= $adresse ?>/images/julien-giraud-developpeur-rubiks-cube.svg" alt="Logo Rubik's Cube Développeur" class="logo-footer">
                    </a>
                    <a href="https://www.linkedin.com/in/julien-giraud" title="Ma page LinkedIn" rel="author noopener noreferrer" target="_blank">
                    <span class="footer-logo-name">.</span>
