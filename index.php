...
$title = "Portfolio - Julien Giraud | Développeur informatique";
$noindex = false;
...
<section class="pt-0">
    <div class="container">
        <h1>Portfolio Julien Giraud | Développeur informatique</h1>
...
<section class="">
    <div class="container">
        <h2>Qui suis-je ?</h2>
        <p>Julien Giraud, je suis un <strong>passionné</strong> d'informatique et d'algorithmique. D'ailleurs j'en fait mon métier.<br>
...
<section class="">
    <div class="container">
        ...
        <ul class="active">
            <li>Peut-on représenter le déplacement des pièces d'un Rubik's Cube 3×3×3 sous la forme d'un graphe planaire orienté ? Eh bien la réponse est non, la preuve est <a href="https://github.com/juliengiraud/Rubik-s_Cube/tree/master/Graphes" title="Graphe des rotations du 3×3×3" rel="help next noopener noreferrer" target="_blank">ici</a>.
            ...
            <li>Quel est le circuit logique le plus optimisé permettant de calculer la position d'arrivée d'une pièce de Rubik's Cube à partir de sa position de départ et du mouvement utilisé ? On pourrait écrire une thèse sur le sujet. Il s'agit en réalité d'un problème <a href="https://fr.wikipedia.org/wiki/Probl%C3%A8me_NP-complet" title="Définition NP-complet sur Wikipédia" rel="help noopener noreferrer" target="_blank">NP-complet</a>, autrement dit on ne peut pas le résoudre en un temps raisonnable. On peut cependant trouver une solution satisfaisante à l'aide des équations logiques. Une synthèse de mon travail sur cette solution se trouve <a href="https://github.com/juliengiraud/Rubik-s_Cube/tree/master/Processor" title="Synthèse circuit logique des rotations du Rubik's Cube" rel="help next noopener noreferrer" target="_blank">ici</a>.</li>
        </ul>
    </div>
</section>
...
<section class="section-border-top">
    <div class="container">
        ...
        <a class="button-link" href="<?= $adresse ?>/realisations-rubiks-cube" rel="next">Voir notre stand</a>

        <h3>Des Rubik's cubes à l'informatique</h3>
        <p>Lorsque j'ai commencé à apprendre la méthode Fridrich (méthode de résolution avancée), il n'était pas facile de se former en ligne avec une synthèse toute faite. Finalement j'ai constitué mon propre <a href="<?= $adresse ?>/formation-rubiks-cube" title="Formation méthode Fridrich">livret sur la méthode Fridrich</a> que j'ai publié sur YouTube. J'ai également travaillé sur différents projets informatiques en rapport avec la modélisation et la <strong>génération d'algorithmes</strong>. L'objectif est soit de comprendre et améliorer une méthode existante, soit d'en créer une pour des cubes qui n'en ont pas encore.</p>
        <a class="button-link" href="<?= $adresse ?>/realisations-rubiks-cube" rel="next">Toutes mes réalisations</a>
    </div>
</section>
